---
title: "Proposal: Funny Project LOL"
...
The source of this data stems from the LendingClub financial services company, where users had the ability to download accepted and rejected applicant data regarding loans. Since 2020, LendingClub no longer supports this functionality. A Kaggle dataset created by the user Nathan George, downloaded/scraped the data while it was available. The applications span from the years 2007-2018.
...
data was obtained by the data owner/curator, as best as you can.
[test](https://www.kaggle.com/datasets/wordsforthewise/lending-club?select=accepted_2007_to_2018Q4.csv.gz). List the 
