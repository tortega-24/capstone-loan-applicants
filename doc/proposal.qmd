...
1. Is employment length related to the acceptance of loans? To answer this, a grouped bar plot will be made, with each employment length category representing two bars. One bar will represent the count of accepted observations, and the other will be the count of rejected observations. The two groups (rejected and accepted) will have different colors. (2.5 hours)
