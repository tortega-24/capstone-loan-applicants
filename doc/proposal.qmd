...
* Build general outline for question 6 (1.5 hours).

**Week 5 (2/13 - 2/19):**

* Build general outline for question 3 (3.5 hours).
* Build general outline for question 1 (2.5 hours).
* Build general outline for question 2 (2.5 hours).

**Week 6 (2/20 - 2/26):**

* Build general outline for question 4 (3 hours).
* Build general outline for question 5 (3 hours).
* Begin to outline the presentation, and assess the status of the project (1 hour).

**Week 7 (2/27 - 3/5):**

* Question 7 (5 hours).
* Starting from question 1 assess each question and update it (2 hours).

**Week 8 (3/6 - 3/12):** *Presentations in class on Thurs 3/9.*

* Assess each question and update it (4 hours).
...
* Work on finishing design for each question (3.5 hours).
* Poster prep (4 hours).
...
* Continue drafting the blog post (4 hours)
* Review final poster for improvements in coding/visuals. Make necessary replacements (3 hours).
